...
php4nano is the evolution of the now archived [easyraikitphp](https://github.com/mikerow/easyraikitphp) repository, which was used between 2016 and 2017 for the then unique block explorer for RaiBlocks [raiblockscommunity.net](https://raiblockscommunity.net) and to manage the distribution of the cryptocurrency through the faucet.
