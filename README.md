...
If you wish to control your node remotely using PHP, I suggest you to use [phpseclib](https://github.com/phpseclib/phpseclib) (e.g. [ncm-remote.php](ncm/examples/ncm-remote.php)).
