<?php
    ...
    class Tools
    {
        ...
        public static function getBlockId( array $hexs ) : string
        {
            ...
            {
                if( !hex2bin( $value ) ) throw new Exception( "Invalid hexadecimal string: $value" );
        ...
        public static function getWork( string $hash, string $difficulty ) : string
        {
            ...
            else 
            {
                ...
                while( true )
                {
                    ...
                    if( strcasecmp( $output, $difficulty ) >= 0 ) return Uint::fromUint8Array( array_reverse( self::bin2arr( $rng ) ) )->toHexString();
                }
            }
        }
        ...
        public static function validWork( string $hash, string $work, string $difficulty ) : bool
        {
            ...
            if( self::hex2dec( $res ) >= self::hex2dec( $difficulty ) ) return true;
